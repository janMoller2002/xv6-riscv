...
sys_getppid(void)
{
    ...
    80002a0a:	ed7fe0ef          	jal	800018e0 <myproc>
    return p->parent->pid;      // Devuelve el pid del proceso padre.
    80002a0e:	7d1c                	ld	a5,56(a0)
}
    80002a10:	5b88                	lw	a0,48(a5)
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002a36:	e5650513          	addi	a0,a0,-426 # 80015888 <bcache>
    80002a3a:	93afe0ef          	jal	80000b74 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002a3e:	0001b797          	auipc	a5,0x1b
    80002a42:	e4a78793          	addi	a5,a5,-438 # 8001d888 <bcache+0x8000>
    80002a46:	0001b717          	auipc	a4,0x1b
    80002a4a:	0aa70713          	addi	a4,a4,170 # 8001daf0 <bcache+0x8268>
    80002a4e:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002a52:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002a56:	00013497          	auipc	s1,0x13
    80002a5a:	e4a48493          	addi	s1,s1,-438 # 800158a0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002ab6:	dd650513          	addi	a0,a0,-554 # 80015888 <bcache>
    80002aba:	93afe0ef          	jal	80000bf4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002abe:	0001b497          	auipc	s1,0x1b
    80002ac2:	0824b483          	ld	s1,130(s1) # 8001db40 <bcache+0x82b8>
    80002ac6:	0001b797          	auipc	a5,0x1b
    80002aca:	02a78793          	addi	a5,a5,42 # 8001daf0 <bcache+0x8268>
    ...
    80002af2:	d9a50513          	addi	a0,a0,-614 # 80015888 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002b04:	0001b497          	auipc	s1,0x1b
    80002b08:	0344b483          	ld	s1,52(s1) # 8001db38 <bcache+0x82b0>
    80002b0c:	0001b797          	auipc	a5,0x1b
    80002b10:	fe478793          	addi	a5,a5,-28 # 8001daf0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002b44:	d4850513          	addi	a0,a0,-696 # 80015888 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002bcc:	cc050513          	addi	a0,a0,-832 # 80015888 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    b->next = bcache.head.next;
    80002bea:	0001b797          	auipc	a5,0x1b
    80002bee:	c9e78793          	addi	a5,a5,-866 # 8001d888 <bcache+0x8000>
    80002bf2:	2b87b703          	ld	a4,696(a5)
    80002bf6:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002bf8:	0001b717          	auipc	a4,0x1b
    80002bfc:	ef870713          	addi	a4,a4,-264 # 8001daf0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002c10:	c7c50513          	addi	a0,a0,-900 # 80015888 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002c40:	c4c50513          	addi	a0,a0,-948 # 80015888 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002c52:	c3a50513          	addi	a0,a0,-966 # 80015888 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    80002c70:	00013517          	auipc	a0,0x13
    80002c74:	c1850513          	addi	a0,a0,-1000 # 80015888 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002c86:	c0650513          	addi	a0,a0,-1018 # 80015888 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002caa:	0001b797          	auipc	a5,0x1b
    80002cae:	2ba7a783          	lw	a5,698(a5) # 8001df64 <sb+0x1c>
...
0000000080002d04 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    80002d0e:	0001b797          	auipc	a5,0x1b
    80002d12:	23e7a783          	lw	a5,574(a5) # 8001df4c <sb+0x4>
    ...
    bp = bread(dev, BBLOCK(b, sb));
    80002d2e:	0001bb17          	auipc	s6,0x1b
    80002d32:	21ab0b13          	addi	s6,s6,538 # 8001df48 <sb>
...
0000000080002ef8 <iget>:
{
  ...
  acquire(&itable.lock);
    80002f0c:	0001b517          	auipc	a0,0x1b
    80002f10:	05c50513          	addi	a0,a0,92 # 8001df68 <itable>
    80002f14:	ce1fd0ef          	jal	80000bf4 <acquire>
  empty = 0;
    80002f18:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002f1a:	0001b497          	auipc	s1,0x1b
    80002f1e:	06648493          	addi	s1,s1,102 # 8001df80 <itable+0x18>
    80002f22:	0001d697          	auipc	a3,0x1d
    80002f26:	aee68693          	addi	a3,a3,-1298 # 8001fa10 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002f52:	01a50513          	addi	a0,a0,26 # 8001df68 <itable>
  ...
  release(&itable.lock);
    ...
    80002f7e:	fee50513          	addi	a0,a0,-18 # 8001df68 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    80002fbc:	0001b997          	auipc	s3,0x1b
    80002fc0:	f8c98993          	addi	s3,s3,-116 # 8001df48 <sb>
  ...
  initlog(dev, &sb);
    80002fe8:	0001b597          	auipc	a1,0x1b
    80002fec:	f6058593          	addi	a1,a1,-160 # 8001df48 <sb>
...
0000000080003010 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    8000302a:	f4250513          	addi	a0,a0,-190 # 8001df68 <itable>
    8000302e:	b47fd0ef          	jal	80000b74 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003032:	0001b497          	auipc	s1,0x1b
    80003036:	f5e48493          	addi	s1,s1,-162 # 8001df90 <itable+0x28>
    8000303a:	0001d997          	auipc	s3,0x1d
    8000303e:	9e698993          	addi	s3,s3,-1562 # 8001fa20 <log+0x10>
...
0000000080003068 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80003074:	ee472703          	lw	a4,-284(a4) # 8001df54 <sb+0xc>
    ...
    80003094:	eb8a0a13          	addi	s4,s4,-328 # 8001df48 <sb>
...
0000000080003124 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    8000313c:	e285a583          	lw	a1,-472(a1) # 8001df60 <sb+0x18>
...
00000000800031a2 <idup>:
{
  ...
  release(&itable.lock);
    ...
    800031c4:	da850513          	addi	a0,a0,-600 # 8001df68 <itable>
...
00000000800031d8 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    8000321a:	d4a5a583          	lw	a1,-694(a1) # 8001df60 <sb+0x18>
...
000000008000335a <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    8000336a:	c0250513          	addi	a0,a0,-1022 # 8001df68 <itable>
  ...
  release(&itable.lock);
    ...
    80003384:	be850513          	addi	a0,a0,-1048 # 8001df68 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800033b0:	bbc50513          	addi	a0,a0,-1092 # 8001df68 <itable>
    ...
    800033d6:	b9650513          	addi	a0,a0,-1130 # 8001df68 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    800038f0:	0001c917          	auipc	s2,0x1c
    800038f4:	12090913          	addi	s2,s2,288 # 8001fa10 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003910:	0001c717          	auipc	a4,0x1c
    80003914:	13070713          	addi	a4,a4,304 # 8001fa40 <log+0x30>
...
0000000080003942 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003946:	0fa7a783          	lw	a5,250(a5) # 8001fa3c <log+0x2c>
    8000394a:	08f05f63          	blez	a5,800039e8 <install_trans+0xa6>
{
    ...
    80003964:	0001ca97          	auipc	s5,0x1c
    80003968:	0dca8a93          	addi	s5,s5,220 # 8001fa40 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000396c:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    8000396e:	0001c997          	auipc	s3,0x1c
    80003972:	0a298993          	addi	s3,s3,162 # 8001fa10 <log>
...
00000000800039ea <initlog>:
{
  ...
  initlock(&log.lock, "log");
    800039fc:	0001c497          	auipc	s1,0x1c
    80003a00:	01448493          	addi	s1,s1,20 # 8001fa10 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003a32:	0001c717          	auipc	a4,0x1c
    80003a36:	00e70713          	addi	a4,a4,14 # 8001fa40 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003a58:	fe07a423          	sw	zero,-24(a5) # 8001fa3c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003a7e:	f9650513          	addi	a0,a0,-106 # 8001fa10 <log>
    80003a82:	972fd0ef          	jal	80000bf4 <acquire>
  while(1){
    if(log.committing){
    80003a86:	0001c497          	auipc	s1,0x1c
    80003a8a:	f8a48493          	addi	s1,s1,-118 # 8001fa10 <log>
      sleep(&log, &log.lock);
    ...
    80003abc:	bff9                	j	80003a9a <begin_op+0x2c>
      ...
      log.outstanding += 1;
    80003abe:	0001c517          	auipc	a0,0x1c
    80003ac2:	f5250513          	addi	a0,a0,-174 # 8001fa10 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003ae8:	f2c48493          	addi	s1,s1,-212 # 8001fa10 <log>
  ...
  if(log.outstanding == 0){
    ...
    80003b08:	f0c48493          	addi	s1,s1,-244 # 8001fa10 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003b20:	ef448493          	addi	s1,s1,-268 # 8001fa10 <log>
    ...
    80003b52:	ec248493          	addi	s1,s1,-318 # 8001fa10 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003b74:	0001ca97          	auipc	s5,0x1c
    80003b78:	ecca8a93          	addi	s5,s5,-308 # 8001fa40 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003b7c:	0001ca17          	auipc	s4,0x1c
    80003b80:	e94a0a13          	addi	s4,s4,-364 # 8001fa10 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003be2:	e407af23          	sw	zero,-418(a5) # 8001fa3c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003c04:	e1090913          	addi	s2,s2,-496 # 8001fa10 <log>
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    80003c18:	0001c797          	auipc	a5,0x1c
    80003c1c:	e147a783          	lw	a5,-492(a5) # 8001fa2c <log+0x1c>
    80003c20:	37fd                	addiw	a5,a5,-1
    80003c22:	04f65c63          	bge	a2,a5,80003c7a <log_write+0x88>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80003c26:	0001c797          	auipc	a5,0x1c
    80003c2a:	e0a7a783          	lw	a5,-502(a5) # 8001fa30 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003c3e:	e0670713          	addi	a4,a4,-506 # 8001fa40 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c5a:	dba78793          	addi	a5,a5,-582 # 8001fa10 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003c6e:	da670713          	addi	a4,a4,-602 # 8001fa10 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c9c:	d7870713          	addi	a4,a4,-648 # 8001fa10 <log>
  ...
  release(&log.lock);
    ...
    80003cae:	d6650513          	addi	a0,a0,-666 # 8001fa10 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003dd4:	d8850513          	addi	a0,a0,-632 # 8001fb58 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003df2:	d6a50513          	addi	a0,a0,-662 # 8001fb58 <ftable>
    80003df6:	dfffc0ef          	jal	80000bf4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003dfa:	0001c497          	auipc	s1,0x1c
    80003dfe:	d7648493          	addi	s1,s1,-650 # 8001fb70 <ftable+0x18>
    80003e02:	0001d717          	auipc	a4,0x1d
    80003e06:	d0e70713          	addi	a4,a4,-754 # 80020b10 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    80003e1a:	d4250513          	addi	a0,a0,-702 # 8001fb58 <ftable>
  ...
  return 0;
    ...
    80003e2e:	d2e50513          	addi	a0,a0,-722 # 8001fb58 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e52:	d0a50513          	addi	a0,a0,-758 # 8001fb58 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003e68:	cf450513          	addi	a0,a0,-780 # 8001fb58 <ftable>
...
fileclose(struct file *f)
{
  ...
  release(&ftable.lock);
    ...
    80003ed6:	c8650513          	addi	a0,a0,-890 # 8001fb58 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003f0e:	c4e50513          	addi	a0,a0,-946 # 8001fb58 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000402c:	0001c717          	auipc	a4,0x1c
    80004030:	a8c70713          	addi	a4,a4,-1396 # 8001fab8 <devsw>
    ...
    8000406a:	10078b63          	beqz	a5,80004180 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800040d2:	9ea70713          	addi	a4,a4,-1558 # 8001fab8 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  ustack[argc] = 0;
    ...
    800046e2:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffde340>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    800052f4:	82078793          	addi	a5,a5,-2016 # 80020b10 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005304:	0001c797          	auipc	a5,0x1c
    80005308:	80c78793          	addi	a5,a5,-2036 # 80020b10 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005330:	7fc50513          	addi	a0,a0,2044 # 80020b28 <disk+0x18>
...
0000000080005358 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000536c:	0001c517          	auipc	a0,0x1c
    80005370:	8cc50513          	addi	a0,a0,-1844 # 80020c38 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    800053d8:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fddb0f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000542a:	0001b497          	auipc	s1,0x1b
    8000542e:	6e648493          	addi	s1,s1,1766 # 80020b10 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000544c:	6d073703          	ld	a4,1744(a4) # 80020b18 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80005460:	0001b497          	auipc	s1,0x1b
    80005464:	6b048493          	addi	s1,s1,1712 # 80020b10 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005580:	6bc50513          	addi	a0,a0,1724 # 80020c38 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    8000558a:	44a1                	li	s1,8
      disk.free[i] = 0;
    8000558c:	0001bb17          	auipc	s6,0x1b
    80005590:	584b0b13          	addi	s6,s6,1412 # 80020b10 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005596:	0001bc17          	auipc	s8,0x1b
    8000559a:	6a2c0c13          	addi	s8,s8,1698 # 80020c38 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    800055b8:	0001b717          	auipc	a4,0x1b
    800055bc:	55870713          	addi	a4,a4,1368 # 80020b10 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800055f0:	0001b517          	auipc	a0,0x1b
    800055f4:	53850513          	addi	a0,a0,1336 # 80020b28 <disk+0x18>
  ...
  if(write)
    8000560c:	0001b797          	auipc	a5,0x1b
    80005610:	50478793          	addi	a5,a5,1284 # 80020b10 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800056e2:	0001b917          	auipc	s2,0x1b
    800056e6:	55690913          	addi	s2,s2,1366 # 80020c38 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    8000570e:	40678793          	addi	a5,a5,1030 # 80020b10 <disk>
    80005712:	97ba                	add	a5,a5,a4
    80005714:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005718:	0001b997          	auipc	s3,0x1b
    8000571c:	3f898993          	addi	s3,s3,1016 # 80020b10 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	4fc50513          	addi	a0,a0,1276 # 80020c38 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    8000576c:	0001b497          	auipc	s1,0x1b
    80005770:	3a448493          	addi	s1,s1,932 # 80020b10 <disk>
    80005774:	0001b517          	auipc	a0,0x1b
    80005778:	4c450513          	addi	a0,a0,1220 # 80020c38 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    800057e8:	0001b517          	auipc	a0,0x1b
    800057ec:	45050513          	addi	a0,a0,1104 # 80020c38 <disk+0x128>
