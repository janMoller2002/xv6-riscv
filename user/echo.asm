...
main(int argc, char *argv[])
{
  ...
  6e:	4505                	li	a0,1
  70:	2e6000ef          	jal	356 <write>
    }
  }
  exit(0);
  74:	4501                	li	a0,0
  76:	2c0000ef          	jal	336 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1cc:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1ce:	85ca                	mv	a1,s2
 1d0:	1be000ef          	jal	38e <fstat>
 1d4:	892a                	mv	s2,a0
  close(fd);
 1d6:	8526                	mv	a0,s1
 1d8:	186000ef          	jal	35e <close>
  return r;
 1dc:	64a2                	ld	s1,8(sp)
}
 1de:	854a                	mv	a0,s2
...
syscall(int num, ...)
{
 ...
 2de:	ec22                	sd	s0,24(sp)
 2e0:	1000                	addi	s0,sp,32
 2e2:	832a                	mv	t1,a0
 2e4:	852e                	mv	a0,a1
 2e6:	e40c                	sd	a1,8(s0)
 2e8:	85b2                	mv	a1,a2
 2ea:	e810                	sd	a2,16(s0)
 2ec:	8636                	mv	a2,a3
 2ee:	ec14                	sd	a3,24(s0)
 2f0:	86ba                	mv	a3,a4
 2f2:	f018                	sd	a4,32(s0)
 2f4:	873e                	mv	a4,a5
 2f6:	f41c                	sd	a5,40(s0)
 2f8:	87c2                	mv	a5,a6
 2fa:	03043823          	sd	a6,48(s0)
 2fe:	03143c23          	sd	a7,56(s0)
 ...
 302:	01040813          	addi	a6,s0,16
 306:	ff043423          	sd	a6,-24(s0)
...
0000000000000316 <getppid>:
{
 ...
 31e:	4559                	li	a0,22
 320:	fbdff0ef          	jal	2dc <syscall>
}
 324:	2501                	sext.w	a0,a0
 326:	60a2                	ld	ra,8(sp)
 328:	6402                	ld	s0,0(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	50650513          	addi	a0,a0,1286 # 918 <digits>
 41a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ac:	270b8b93          	addi	s7,s7,624 # 918 <digits>
