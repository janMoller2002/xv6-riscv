...
int main(int argc, char *argv[]) {
  ...
  26:	fce5                	bnez	s1,1e <main+0x1e>
    ...
    exit(0);
  28:	4501                	li	a0,0
  2a:	294000ef          	jal	2be <exit>
            sleep(i);  // Dejar que cada hijo espere un poco antes de imprimir
  2e:	8526                	mv	a0,s1
  30:	31e000ef          	jal	34e <sleep>
            printf("Ejecutando proceso hijo %d, pid %d\n", i, getpid());
  34:	30a000ef          	jal	33e <getpid>
  38:	862a                	mv	a2,a0
  3a:	85a6                	mv	a1,s1
  3c:	00001517          	auipc	a0,0x1
  40:	85450513          	addi	a0,a0,-1964 # 890 <malloc+0x106>
  44:	692000ef          	jal	6d6 <printf>
            sleep(10);  // El proceso duerme por 10 ticks
  48:	4529                	li	a0,10
  4a:	304000ef          	jal	34e <sleep>
            exit(0);
  4e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39e:	52650513          	addi	a0,a0,1318 # 8c0 <digits>
 3a2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 634:	290b8b93          	addi	s7,s7,656 # 8c0 <digits>
 ...
 682:	23a90913          	addi	s2,s2,570 # 8b8 <malloc+0x12e>
        for(; *s; s++)
