...
stat(const char *n, struct stat *st)
{
 ...
 1b8:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1ba:	85ca                	mv	a1,s2
 1bc:	1be000ef          	jal	37a <fstat>
 1c0:	892a                	mv	s2,a0
  close(fd);
 1c2:	8526                	mv	a0,s1
 1c4:	186000ef          	jal	34a <close>
  return r;
 1c8:	64a2                	ld	s1,8(sp)
}
 1ca:	854a                	mv	a0,s2
...
syscall(int num, ...)
{
 ...
 2d8:	8636                	mv	a2,a3
 2da:	ec14                	sd	a3,24(s0)
 2dc:	86ba                	mv	a3,a4
 2de:	f018                	sd	a4,32(s0)
 2e0:	873e                	mv	a4,a5
 2e2:	f41c                	sd	a5,40(s0)
 2e4:	87c2                	mv	a5,a6
 2e6:	03043823          	sd	a6,48(s0)
 2ea:	03143c23          	sd	a7,56(s0)
 ...
 2ee:	01040813          	addi	a6,s0,16
 2f2:	ff043423          	sd	a6,-24(s0)
 ...
 2fc:	6462                	ld	s0,24(sp)
 2fe:	6125                	addi	sp,sp,96
 300:	8082                	ret

0000000000000302 <getppid>:
{
 ...
 30a:	4559                	li	a0,22
 30c:	fbdff0ef          	jal	2c8 <syscall>
}
 310:	2501                	sext.w	a0,a0
 312:	60a2                	ld	ra,8(sp)
 314:	6402                	ld	s0,0(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	53250513          	addi	a0,a0,1330 # 930 <digits>
 406:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 698:	29cb8b93          	addi	s7,s7,668 # 930 <digits>
