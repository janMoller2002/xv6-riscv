...
user/_testimmutable:     file format elf64-littleriscv
...
main(void)
{
  ...
  10:	99450513          	addi	a0,a0,-1644 # 9a0 <malloc+0x106>
  14:	3f2000ef          	jal	406 <open>
    if(fd < 0){
  18:	0c054a63          	bltz	a0,ec <main+0xec>
  1c:	ec26                	sd	s1,24(sp)
  1e:	84aa                	mv	s1,a0
  ...
  26:	9a658593          	addi	a1,a1,-1626 # 9c8 <malloc+0x12e>
  2a:	3bc000ef          	jal	3e6 <write>
    close(fd);
  2e:	8526                	mv	a0,s1
  30:	3be000ef          	jal	3ee <close>

    // Cambiar permisos a inmutable
    if(chmod("immutablefile", 5) < 0){
  34:	4595                	li	a1,5
  36:	00001517          	auipc	a0,0x1
  3a:	96a50513          	addi	a0,a0,-1686 # 9a0 <malloc+0x106>
  3e:	428000ef          	jal	466 <chmod>
  42:	0a054f63          	bltz	a0,100 <main+0x100>
        printf("Failed to set file as immutable\n");
        exit(1);
    } else {
        printf("Set immutablefile as immutable\n");
  46:	00001517          	auipc	a0,0x1
  4a:	9b250513          	addi	a0,a0,-1614 # 9f8 <malloc+0x15e>
  4e:	798000ef          	jal	7e6 <printf>
    }
  ...
  58:	94c50513          	addi	a0,a0,-1716 # 9a0 <malloc+0x106>
  5c:	3aa000ef          	jal	406 <open>
  60:	84aa                	mv	s1,a0
    if(fd >= 0){
  62:	0a054f63          	bltz	a0,120 <main+0x120>
        if(write(fd, "world", 5) >= 0)
  66:	4615                	li	a2,5
  68:	00001597          	auipc	a1,0x1
  6c:	9b058593          	addi	a1,a1,-1616 # a18 <malloc+0x17e>
  70:	376000ef          	jal	3e6 <write>
  74:	08054f63          	bltz	a0,112 <main+0x112>
            printf("Error: Should not be able to write to immutable file\n");
  78:	00001517          	auipc	a0,0x1
  7c:	9a850513          	addi	a0,a0,-1624 # a20 <malloc+0x186>
  80:	766000ef          	jal	7e6 <printf>
        else
            printf("Correct: Cannot write to immutable file\n");
        close(fd);
  84:	8526                	mv	a0,s1
  86:	368000ef          	jal	3ee <close>
    } else {
  ...
  90:	91450513          	addi	a0,a0,-1772 # 9a0 <malloc+0x106>
  94:	3d2000ef          	jal	466 <chmod>
  98:	08054b63          	bltz	a0,12e <main+0x12e>
  ...
  a0:	a5c50513          	addi	a0,a0,-1444 # af8 <malloc+0x25e>
  a4:	742000ef          	jal	7e6 <printf>
    }
  ...
  ae:	8f650513          	addi	a0,a0,-1802 # 9a0 <malloc+0x106>
  b2:	354000ef          	jal	406 <open>
  b6:	84aa                	mv	s1,a0
    if(fd >= 0){
  b8:	08054b63          	bltz	a0,14e <main+0x14e>
        char buf[6] = {0};
  bc:	fc042c23          	sw	zero,-40(s0)
  c0:	fc041e23          	sh	zero,-36(s0)
        if(read(fd, buf, 5) == 5)
  c4:	4615                	li	a2,5
  c6:	fd840593          	addi	a1,s0,-40
  ca:	314000ef          	jal	3de <read>
  ce:	4795                	li	a5,5
  d0:	06f50663          	beq	a0,a5,13c <main+0x13c>
            printf("Read success: %s\n", buf);
        else
            printf("Error: Failed to read immutable file\n");
  d4:	00001517          	auipc	a0,0x1
  d8:	a8450513          	addi	a0,a0,-1404 # b58 <malloc+0x2be>
  dc:	70a000ef          	jal	7e6 <printf>
        close(fd);
  e0:	8526                	mv	a0,s1
  e2:	30c000ef          	jal	3ee <close>
    } else {
    ...
    exit(0);
  e6:	4501                	li	a0,0
  e8:	2de000ef          	jal	3c6 <exit>
  ec:	ec26                	sd	s1,24(sp)
        printf("Failed to create file\n");
  ee:	00001517          	auipc	a0,0x1
  f2:	8c250513          	addi	a0,a0,-1854 # 9b0 <malloc+0x116>
  f6:	6f0000ef          	jal	7e6 <printf>
        exit(1);
  fa:	4505                	li	a0,1
  fc:	2ca000ef          	jal	3c6 <exit>
        printf("Failed to set file as immutable\n");
 100:	00001517          	auipc	a0,0x1
 104:	8d050513          	addi	a0,a0,-1840 # 9d0 <malloc+0x136>
 108:	6de000ef          	jal	7e6 <printf>
        exit(1);
 10c:	4505                	li	a0,1
 10e:	2b8000ef          	jal	3c6 <exit>
            printf("Correct: Cannot write to immutable file\n");
 112:	00001517          	auipc	a0,0x1
 116:	94650513          	addi	a0,a0,-1722 # a58 <malloc+0x1be>
 11a:	6cc000ef          	jal	7e6 <printf>
 11e:	b79d                	j	84 <main+0x84>
        printf("Correct: Cannot open immutable file for writing\n");
 120:	00001517          	auipc	a0,0x1
 124:	96850513          	addi	a0,a0,-1688 # a88 <malloc+0x1ee>
 128:	6be000ef          	jal	7e6 <printf>
 12c:	bfb9                	j	8a <main+0x8a>
        printf("Correct: Cannot change permissions of immutable file\n");
 12e:	00001517          	auipc	a0,0x1
 132:	99250513          	addi	a0,a0,-1646 # ac0 <malloc+0x226>
 136:	6b0000ef          	jal	7e6 <printf>
 13a:	b7bd                	j	a8 <main+0xa8>
            printf("Read success: %s\n", buf);
 13c:	fd840593          	addi	a1,s0,-40
 140:	00001517          	auipc	a0,0x1
 144:	a0050513          	addi	a0,a0,-1536 # b40 <malloc+0x2a6>
 148:	69e000ef          	jal	7e6 <printf>
 14c:	bf51                	j	e0 <main+0xe0>
        printf("Error: Failed to open immutable file for reading\n");
 14e:	00001517          	auipc	a0,0x1
 152:	a3250513          	addi	a0,a0,-1486 # b80 <malloc+0x2e6>
 156:	690000ef          	jal	7e6 <printf>
 15a:	b771                	j	e6 <main+0xe6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	71650513          	addi	a0,a0,1814 # bc0 <digits>
 4b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 744:	480b8b93          	addi	s7,s7,1152 # bc0 <digits>
 ...
 792:	42a90913          	addi	s2,s2,1066 # bb8 <malloc+0x31e>
        for(; *s; s++)
