...
main(void)
{
  ...
  if(fork() > 0)
   8:	2ca000ef          	jal	2d2 <fork>
   c:	00a04563          	bgtz	a0,16 <main+0x16>
    sleep(5);  // Let child exit before parent.
  exit(0);
  10:	4501                	li	a0,0
  12:	2c8000ef          	jal	2da <exit>
    sleep(5);  // Let child exit before parent.
  16:	4515                	li	a0,5
  18:	352000ef          	jal	36a <sleep>
...
stat(const char *n, struct stat *st)
{
 ...
 170:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 172:	85ca                	mv	a1,s2
 174:	1be000ef          	jal	332 <fstat>
 178:	892a                	mv	s2,a0
  close(fd);
 17a:	8526                	mv	a0,s1
 17c:	186000ef          	jal	302 <close>
  return r;
 180:	64a2                	ld	s1,8(sp)
}
 182:	854a                	mv	a0,s2
...
syscall(int num, ...)
{
 ...
 28a:	e40c                	sd	a1,8(s0)
 28c:	85b2                	mv	a1,a2
 28e:	e810                	sd	a2,16(s0)
 290:	8636                	mv	a2,a3
 292:	ec14                	sd	a3,24(s0)
 294:	86ba                	mv	a3,a4
 296:	f018                	sd	a4,32(s0)
 298:	873e                	mv	a4,a5
 29a:	f41c                	sd	a5,40(s0)
 29c:	87c2                	mv	a5,a6
 29e:	03043823          	sd	a6,48(s0)
 2a2:	03143c23          	sd	a7,56(s0)
 ...
 2a6:	01040813          	addi	a6,s0,16
 2aa:	ff043423          	sd	a6,-24(s0)
...
00000000000002ba <getppid>:
{
 ...
 2c2:	4559                	li	a0,22
 2c4:	fbdff0ef          	jal	280 <syscall>
}
 2c8:	2501                	sext.w	a0,a0
 2ca:	60a2                	ld	ra,8(sp)
 2cc:	6402                	ld	s0,0(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	4f250513          	addi	a0,a0,1266 # 8a8 <digits>
 3be:	883a                	mv	a6,a4
